...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        ...
        insert_recipe('Batata Suica', '00:25:00', '<li>Grate raw potatoes, squeeze out excess liquid, and season with salt and pepper.<li>Heat butter in a non-stick skillet, add a layer of potatoes, and cook until golden.<li>Flip carefully, cook the other side, and serve hot.', batatasuica.ingredientes, batatasuica.utensilios)
        insert_recipe('Biscoito de Aveia com Hortela', '00:15:00', '<li>Mix oats, flour, chopped mint, and sugar in a bowl.<li>Add melted butter and milk, stirring until combined.<li>Shape into cookies and bake at 180°C until golden.', biscoitodeaveiacomhortela.ingredientes, biscoitodeaveiacomhortela.utensilios)
